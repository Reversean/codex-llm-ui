...
Веб-приложение для взаимодействия с LLM (Large Language Model) через удобный чат-интерфейс. Поддерживает потоковую
передачу ответов в режиме реального времени, отображение процесса размышления модели и рендеринг Markdown.
